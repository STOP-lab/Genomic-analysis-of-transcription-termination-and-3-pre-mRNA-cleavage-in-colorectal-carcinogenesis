...
samtools merge -@ 14 -bh Replicates/Merged-BAMs1CT-T4ph-Reps_merged.bam Aligned/1CT-T4ph_rep1-STARAligned.sortedByCoord.out.bam Aligned/1CT-T4ph_rep2-STARAligned.sortedByCoord.out.bam
samtools merge -@ 14 -bh Replicates/Merged-BAMsHCT116-T4ph-Reps_merged.bam Aligned/HCT116-T4ph_rep1-STARAligned.sortedByCoord.out.bam Aligned/HCT116-T4ph_rep2-STARAligned.sortedByCoord.out.bam
samtools merge -@ 14 -bh Replicates/Merged-BAMsSW480-T4ph-Reps_merged.bam Aligned/SW480-T4ph_rep1-STARAligned.sortedByCoord.out.bam Aligned/SW480-T4ph_rep2-STARAligned.sortedByCoord.out.bam
samtools merge -@ 14 -bh Replicates/Merged-BAMsSW620-T4ph-Reps_merged.bam Aligned/SW620-T4ph_rep1-STARAligned.sortedByCoord.out.bam Aligned/SW620-T4ph_rep2-STARAligned.sortedByCoord.out.bam Aligned/SW620-T4ph_rep3-STARAligned.sortedByCoord.out.bam
