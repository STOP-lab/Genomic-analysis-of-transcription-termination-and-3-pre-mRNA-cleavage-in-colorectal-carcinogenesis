...
### Load the Single nucleotide resolution genome covergae files(bedgraphs) for the normalisation
setwd("ColoRectal_Cancer/mNET-Seq/Replicates/Stranded_bedGraphs/SNR/")
gdzie<-getwd()
sampleFiles2 <- grep(".bedGraph",list.files(gdzie),value=TRUE)

## Create another SampleTable with the bedGraphs
sampleNames2<-c("HCEC_1CT-T4ph-SNR-fwd", "HCEC_1CT-T4ph-SNR-rev", "HCEC_1CT-Total-SNR-fwd", "HCEC_1CT-Total-SNR-rev", "HCT116-T4ph-SNR-fwd", "HCT116-T4ph-SNR-rev", "HCT116-Total-SNR-fwd", "HCT116-Total-SNR-rev", "SW480-T4ph-SNR-fwd", "SW480-T4ph-SNR-rev", "SW480-Total-SNR-fwd", "SW480-Total-SNR-rev", "SW620-T4ph-SNR-fwd", "SW620-T4ph-SNR-rev", "SW620-Total-SNR-fwd", "SW620-Total-SNR-rev")
